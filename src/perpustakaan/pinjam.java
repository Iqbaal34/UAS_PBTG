...
Object kolom []={"NIM", "Nama","Kelas", "Kode_Buku", "Nama_Buku", "Penerbit", "Tanggal_Pinjam", "Tanggal_Kembali", "Lama_Pinjam"};
...
Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/uaspbtg", "root", "");
...
String Kode=res.getString("Kode_Buku");
String Nabuk=res.getString("Nama_Buku");
String Penerbit=res.getString("Penerbit");
String tglp=res.getString("Tanggal_Pinjam");
String tglk=res.getString("Tanggal_Kembali");
String lamap=res.getString("Lama_Pinjam");
...
JOptionPane.showMessageDialog(this, "Error: "+ex);
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/uasbptg", "root", "");
            Statement stat= conn.createStatement();
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        ...
        try {
            ...
            String sql="update karyawan set NIM=?,Nama=?,Kelas=?,Kode_Buku=?,Nama_Buku=?,Penerbit=?, Tanggal_Pinjam=?,Tanggal_Kembali=?,Lama_Pinjam=?, where "+"NIM='"+nim.getText()+"'";
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            Connection conn =DriverManager.getConnection("jdbc:mysql://127.0.0.1/uaspbtg", "root", "");
            Statement stat= conn.createStatement();
            String sql="delete from peminjam where NIM='"+x+"'";
